(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.calendar = factory());
	...
	function check(newData, old) {
	    Object.keys(newData).forEach(function (e) {
	        if (Array.isArray(newData[e])) {
	            newData[e].forEach((et) => {
	                if (typeof et !== "string") {
	            ...
	            if (!old.hasOwnProperty(e)) {
	                ...
	                old[e] = newFes.filter(function (item, index, array) {
	...
	const FestivalDay = function (m, d, data, type = true) {
	    const day = (m < 10 ? "0" + m : m.toString()) + (d < 10 ? "0" + d : d.toString());
	    let FDays = [];
	    if (type) {
	        if (data.sFtv) {
